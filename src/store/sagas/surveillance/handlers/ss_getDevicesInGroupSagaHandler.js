...
function* ss_getDevicesInGroupSagaHandler(action) {
  SystemEventsHandler.onInfo({
    info: 'ss_getDevicesInGroupSagaHandler: ' + JSON.stringify(action),
  });
...
export default ss_getDevicesInGroupSagaHandler;
