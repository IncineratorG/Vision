  ...
  return (
    <Portal>
      <Dialog visible={visible} onDismiss={onCancelPress}>
        <Dialog.Title>{t('RegisterDeviceInGroupDialog_title')}</Dialog.Title>
        <Dialog.Content>
          <View style={styles.mainContainer}>
            <View style={styles.groupNameContainer}>
              <TextInput
                ...
                placeholder={t(
                  'RegisterDeviceInGroupDialog_groupNamePlaceholder',
                )}
            ...
            <View style={styles.groupPasswordContainer}>
              <TextInput
                ...
                placeholder={t(
                  'RegisterDeviceInGroupDialog_groupPasswordPlaceholder',
                )}
            ...
            <View style={styles.deviceNameContainer}>
              <TextInput
                ...
                placeholder={t(
                  'RegisterDeviceInGroupDialog_deviceNamePlaceholder',
                )}
        ...
        <Dialog.Actions>
          <Button onPress={registerPressHandler}>
            {t('RegisterDeviceInGroupDialog_registerButton')}
          </Button>
          <Button onPress={cancelPressHandler}>
            {t('RegisterDeviceInGroupDialog_cancelButton')}
          </Button>
        </Dialog.Actions>
      </Dialog>
    </Portal>
...
export default React.memo(RegisterDeviceInGroupDialog);
