...
public class StopRecognizePersonRequestPayload implements ServiceRequestPayload {
    private final String CAMERA_TYPE_FIELD = "cameraType";

    private JSONObject mJsonObject;

    public StopRecognizePersonRequestPayload(String cameraType) {
    ...
    public StopRecognizePersonRequestPayload(JSONObject jsonObject) {
        try {
