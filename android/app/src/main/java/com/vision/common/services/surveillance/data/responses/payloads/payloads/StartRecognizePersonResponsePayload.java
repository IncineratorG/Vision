...
public class StartRecognizePersonResponsePayload implements ServiceResponsePayload {
    ...
    public StartRecognizePersonResponsePayload(boolean frontCameraRecognizeServiceRunning,
    ...
    public StartRecognizePersonResponsePayload(JSONObject jsonObject) {
        try {
