package com.vision.common.services.camera.data.camera_tasks.tasks.take_back_camera_image;
...
public class TakeBackCameraImageCameraTask implements CameraFrameChangedTask {
    private String mQuality;
    private long mStartTaskTimestamp = -1;
    private OnImageTaken mImageTakenCallback;
    private OnImageTakeError mErrorCallback;

    public TakeBackCameraImageCameraTask(String quality,
    ...
    public String getType() {
        return CameraTaskTypes.TAKE_BACK_CAMERA_IMAGE;
    }
