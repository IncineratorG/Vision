package com.vision.rn_modules.surveillance.module_actions.payloads.payloads;

import com.facebook.react.bridge.ReadableMap;
import com.vision.rn_modules.modules_common.interfaces.js_payload.JSPayload;

public class GetDevicesInGroupPayload implements JSPayload {
    ...
    public GetDevicesInGroupPayload(ReadableMap readableMap) {
        if (readableMap == null) {
            return;
        }
