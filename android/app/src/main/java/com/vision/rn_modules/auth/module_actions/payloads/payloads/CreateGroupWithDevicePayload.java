package com.vision.rn_modules.auth.module_actions.payloads.payloads;

import com.facebook.react.bridge.ReadableMap;
import com.vision.rn_modules.modules_common.interfaces.js_payload.JSPayload;

public class CreateGroupWithDevicePayload implements JSPayload {
    ...
    public CreateGroupWithDevicePayload(ReadableMap readableMap) {
        if (readableMap == null) {
            return;
        }
