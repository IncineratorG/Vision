package com.vision.rn_modules.auth;
...
import com.vision.rn_modules.auth.module_actions_executor.AuthJSActionsExecutor;
...
public class AuthModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        actionTypesConstants.putString(AuthJSActionTypes.GET_CURRENT_AUTHENTICATION_DATA, AuthJSActionTypes.GET_CURRENT_AUTHENTICATION_DATA);
