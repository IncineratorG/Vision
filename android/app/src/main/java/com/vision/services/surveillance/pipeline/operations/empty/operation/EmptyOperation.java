...
import com.vision.services.surveillance.pipeline.operations.empty.status.EmptyOperationStatus;
...
public class EmptyOperation implements PipelineOperation {
    ...
    public void run(PipelineJobs jobs, OnTaskSuccess<PipelineOperationState> onSuccess, OnTaskError<Object> onError) {
        ...
        onSuccess.onSuccess(new PipelineOperationState(this, new EmptyOperationStatus()));
    }
}
