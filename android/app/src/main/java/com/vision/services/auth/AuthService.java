package com.vision.services.auth;
...
import com.vision.services.auth.data.service_errors.AuthServiceErrors;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (deviceInfoSnapshot.exists()) {
                    ...
                    if (deviceInfoObject != null) {
                        ...
                        DeviceInfo updatedDeviceInfo = DeviceInfoService.get().updateDeviceInfo(context, deviceInfo, true);
