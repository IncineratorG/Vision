package com.vision.services.surveillance.requests.executor.firebase;
...
import com.vision.services.surveillance.requests.handlers.get_camera_recognize_person_settings.GetCameraRecognizePersonSettingsServiceHandler;
import com.vision.services.surveillance.requests.handlers.is_device_alive.IsDeviceAliveServiceHandler;
import com.vision.services.surveillance.requests.handlers.take_back_camera_image.TakeBackCameraImageServiceHandler;
import com.vision.services.surveillance.requests.handlers.take_front_camera_image.TakeFrontCameraImageServiceHandler;
import com.vision.services.surveillance.requests.handlers.test_with_payload.TestRequestWithPayloadServiceHandler;
import com.vision.services.surveillance.requests.handlers.toggle_detect_device_movement.ToggleDetectDeviceMovementServiceHandler;
import com.vision.services.surveillance.requests.handlers.toggle_recongnize_person.ToggleRecognizePersonServiceHandler;
import com.vision.services.surveillance.requests.handlers.unknown.UnknownRequestServiceHandler;
...
public class FBSRequestsExecutor implements ServiceRequestsExecutor {
    ...
    public FBSRequestsExecutor() {
        ...
        mHandlers.put(SurveillanceServiceRequestTypes.GET_CAMERA_RECOGNIZE_PERSON_SETTINGS, new GetCameraRecognizePersonSettingsServiceHandler());
    }
